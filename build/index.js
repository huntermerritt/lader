...
function getTerraformFiles(startingPath) {
    return __awaiter(this, void 0, void 0, function* () {
        let directories = yield (0, glob_1.glob)(startingPath + "/**/*.tf");
        ...
        (0, fs_1.writeFileSync)("lading.json", JSON.stringify({ "project": projectRoot, "tf-items": finalItems, "updated": new Date() }, null, 2));
    });
}
function getVersionsSrc(filePath, projectRoot) {
...
console.log((0, figlet_1.textSync)("Lading"));
